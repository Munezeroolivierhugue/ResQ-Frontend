  ...
  return (
    <div className="p-6 max-w-3xl">
      ...
      {sent ? (
        <div className="rounded-xl border border-(--border) bg-(--bg-surface) p-5 shadow-[var(--shadow-card)]">
          ...
          <div className="flex gap-2">
            ...
            <button
              type="button"
              onClick={copyLink}
              className="h-10 px-3 rounded-lg border border-(--border) bg-(--bg-elevated) cursor-pointer flex items-center gap-1.5 text-[12px] font-semibold"
            >
              <Copy size={14} />
              Copy
            </button>
        ...
        <form onSubmit={handleSubmit} className="rounded-xl border border-(--border) bg-(--bg-surface) p-5 shadow-[var(--shadow-card)] space-y-4">
          ...
          <button type="submit" className="auth-primary-btn" style={{ width: 'auto', paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
            <Send size={16} />
