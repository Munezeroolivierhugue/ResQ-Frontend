...
export default function LoginMfa() {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      navigatePortal(
        ROLE_MAP[role] ?? (role?.toLowerCase() || "dispatcher"),
        navigate,
      );
    } catch (err) {
      setError(
    ...
    <AuthCenterLayout>
      <div className="auth-otp-card">
        ...
        <p className="auth-otp-desc">
          ...
          <strong>{email || "your email"}</strong>. Enter it below to authorize
          this terminal. The code expires in <strong>5 minutes</strong>.
        </p>
