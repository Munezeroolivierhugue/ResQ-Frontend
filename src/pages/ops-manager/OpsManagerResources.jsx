        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="dispatcher-surface p-5">
            ...
            {submitted ? (
              ...
              >
                <div className="font-bold text-(--status-low)">
                  Request submitted
                </div>
                <p className="text-[13px] text-(--text-secondary) m-0">
                  {form.qty}× {form.unitType} requested from{" "}
                  {form.targetDistrict} for {form.duration}.
                </p>
                <button
                  type="button"
              ...
              <div className="flex flex-col gap-3 mt-4">
                <label className="dispatcher-field">
                  ...
                  >
                    {["Police Van", "Motorcycle", "Ambulance", "Fire Unit"].map(
                      (t) => (
                ...
                <label className="dispatcher-field">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setForm((f) => ({ ...f, targetDistrict: e.target.value }))
                    }
                  >
                    {["Bugesera", "Rwamagana", "Gasabo", "Kicukiro"].map(
                      (d) => (
            ...
            <div className="mt-4">
              {OPS_MUTUAL_AID_HISTORY.map((r) => (
                ...
                >
                  ...
                  {r.arrived && (
                    <div className="text-[11px] text-(--status-low) mt-1">
                      {r.arrived}
                    </div>
                  )}
                </div>
