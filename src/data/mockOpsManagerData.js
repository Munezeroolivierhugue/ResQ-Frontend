...
export const OPS_AI_RECOMMENDATIONS = [
  ...
  },
  {
    id: 'REC-0042',
    status: 'pending',
    text: 'Move POL-12 → Nyamirambo Patrol Loop',
    reason: 'Coverage gap detected after INC-2403 resource draw',
    impact: '+4.1% zone coverage',
    confidence: 76,
    detail: 'Relocate POL-12 from Gasabo HQ to Nyamirambo Patrol Loop',
...
export const OPS_DISPATCHERS = [
  { id: 'DSP-0042', name: 'Jean Bosco Nkurunziza', initials: 'JB', workload: 'normal', incidents: 4, handledToday: 31, aiRate: 94, status: 'ON DUTY' },
  { id: 'DSP-0018', name: 'Aline Mukamana', initials: 'AM', workload: 'high', incidents: 9, handledToday: 44, aiRate: 71, status: 'ON DUTY' },
  { id: 'DSP-0027', name: 'Claude Kabera', initials: 'CK', workload: 'normal', incidents: 3, handledToday: 28, aiRate: 88, status: 'ON DUTY' },
  { id: 'DSP-0033', name: 'Divine Uwase', initials: 'DU', workload: 'overload', incidents: 12, handledToday: 52, aiRate: 58, status: 'ON BREAK' },
]
...
export const OPS_ESCALATION_DETAIL = {
  ...
  'INC-2407': {
    ...
    type: 'Armed Robbery in Progress',
    severity: 'high',
    location: 'Kicukiro · Sonatubes sector',
    lat: -1.9892,
    lng: 30.1124,
    ...
    fieldUpdates: [
      { id: 1, time: '14:15', title: 'Suspect direction — eastbound', description: 'Witness reports two males on motorcycle fled toward Remera.' },
      { id: 2, time: '14:10', title: 'Scene secured', description: 'Shop owner safe — no injuries confirmed.' },
    ],
    units: [
      { id: 'POL-08', type: 'Police', status: 'ON SCENE', eta: null, lat: -1.989, lng: 30.112 },
      { id: 'P-07', type: 'Police Van', status: 'EN ROUTE', eta: '3 min', lat: -1.995, lng: 30.105 },
    ],
  },
}
...
export const OPS_SHIFT_HANDOVER = {
  ...
  unitIssues: [
    'P-03 — mechanical fault, restricted to Gasabo depot until 10:00',
  ...
  notes: 'Heavy medical load in Nyarugenge between 04:00–06:00. Recommend keeping AMB-11 pre-positioned in Kacyiru for morning peak. Mutual aid from Bugesera arrived on time — no issues.',
  stats: {
    incidents: 198,
    avgResponse: '7.8m',
    coverage: '91%',
...
export const OPS_SHIFT_REPORT_INCIDENTS = [
  { id: 'INC-2398', type: 'Traffic Accident', severity: 'HIGH', duration: '42m', units: 3, outcome: 'Resolved — 2 transported' },
  { id: 'INC-2403', type: 'Structure Fire', severity: 'CRITICAL', duration: 'ongoing', units: 5, outcome: 'Active — OM commanding' },
  { id: 'INC-2405', type: 'Public Disturbance', severity: 'MEDIUM', duration: '28m', units: 2, outcome: 'Resolved — dispersed' },
  { id: 'INC-2407', type: 'Armed Robbery', severity: 'HIGH', duration: '18m', units: 3, outcome: 'Active — pursuit' },
]
...
export const OPS_RESOURCE_EVENTS = [
  ...
  { time: '11:45', title: 'Reallocation executed', description: 'REC-0035 — P-07 moved to Kimironko Standby B' },
...
export const OPS_SUPERVISOR_MESSAGES = [
  { time: '14:22', from: 'Jean Bosco', text: 'INC-2407 resources sufficient — monitoring.' },
  { time: '14:10', from: 'Aline M.', text: 'Queue at 9 — request redistribution support.' },
  { time: '13:55', from: 'Claude K.', text: 'AI recommendation REC-0041 looks valid for Kimironko.' },
  { time: '13:40', from: 'Divine U.', text: 'Returning from break in 10 min.' },
  { time: '13:15', from: 'Jean Bosco', text: 'Handover notes reviewed — ready for peak.' },
]
